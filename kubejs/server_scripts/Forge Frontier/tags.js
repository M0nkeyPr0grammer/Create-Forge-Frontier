...
// forge:enegergized/blocks
event.add('forge:energized/blocks','forge_frontier:overcharged_iron_block')
event.add('forge:energized/blocks','forge_frontier:overcharged_gold_block')
event.add('forge:energized/blocks','forge_frontier:overcharged_diamond_block')
event.add('forge:energized/blocks','forge_frontier:overcharged_netherite_block')

// create:crushed_raw_materials/piles
event.add('create:crushed_raw_materials/piles','create_compressed:crushed_iron_pile')
event.add('create:crushed_raw_materials/piles','create_compressed:crushed_zinc_pile')
event.add('create:crushed_raw_materials/piles','create_compressed:crushed_copper_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_bismuth_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_calorite_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_desh_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_irradium_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_malachite_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_ostrum_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_tin_pile')
event.add('create:crushed_raw_materials/piles','forge_frontier:crushed_uranium_pile')

// create:crushed_raw_materials
event.add('create:crushed_raw_materials','forge_frontier:crushed_desh_ore')
event.add('create:crushed_raw_materials','forge_frontier:crushed_ostrum_ore')
event.add('create:crushed_raw_materials','forge_frontier:crushed_calorite_ore')
